            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-sm rounded-0" reqiured="" name="contact" id="contact" maxlength="10">
                </div>
                <div class="form-group">
  ...
  <script>
    ...
    function validateForm() {
      ...
      if (contact == "" || !contactPattern.test(contact)) {
        alert("Valid 10-digit contact number is required");
        return false;
      }
      ...
      var avatar = document.getElementById("customFile").value;
      if (avatar == "") {
